...
def str_fraction(npy_path):
    """Calculate stroma fraction"""
    return calculate_tissue_fraction(npy_path, 7)

def mus_fraction(npy_path):
    """Calculate muscle fraction"""
    return calculate_tissue_fraction(npy_path, 5)

def tum_fraction(npy_path):
    """Calculate tumor fraction"""
    return calculate_tissue_fraction(npy_path, 8) 